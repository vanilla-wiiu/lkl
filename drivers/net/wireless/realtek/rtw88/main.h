...
/* devm_kmemdup_array() landed after 6.12.0; this LKL tree is 6.12.0 and lacks
 * it, so the shim must cover 6.12.x too (lwfinger's original < 6.12.0 guard
 * assumed 6.12 already had it). */
